    ...
    Year(
      ...
      [
        ...
        Semester(
          1,
          [
            Course(0, 'ArtAp 10', '', AppColors.ACCENTS[0].value, 101010, 0900,
                1000, 0, '', '', 3, 4.0, true),
            Course(0, 'CSCI 30', '', AppColors.ACCENTS[1].value, 010100, 1100,
                1230, 0, '', '', 3, 4.0, true),
            Course(0, 'MATH 30.24', '', AppColors.ACCENTS[2].value, 010100,
                1530, 1700, 0, '', '', 4, 3.5, true),
            Course(0, 'MATH 51.3', '', AppColors.ACCENTS[3].value, 101010, 0800,
                0900, 0, '', '', 3, 4.0, true),
            Course(0, 'PHILO 11.04', '', AppColors.ACCENTS[4].value, 010100,
                1400, 1530, 0, '', '', 3, 3.5, true),
            Course(0, 'PHYED 161', '', AppColors.ACCENTS[0].value, 010100, 0900,
                1000, 0, '', '', 2, 4.0, false),
            Course(0, 'PHYS 23.11', '', AppColors.ACCENTS[1].value, 101010,
                1100, 1200, 0, '', '', 3, 3.5, true),
            Course(0, 'PHYS 23.12', '', AppColors.ACCENTS[2].value, 001010,
                1300, 1500, 0, '', '', 2, 4.0, true),
          ],
        ),
        Semester(
          2,
          [
            Course(0, 'CSCI 40', '', AppColors.ACCENTS[0].value, 101010, 1400,
                1500, 0, '', '', 3, 4.0, true),
            Course(0, 'HISTO 12', '', AppColors.ACCENTS[1].value, 101010, 1500,
                1600, 0, '', '', 3, 4.0, true),
            Course(0, 'JPN 11', '', AppColors.ACCENTS[2].value, 010100, 1400,
                1530, 0, '', '', 3, 4.0, true),
            Course(0, 'MATH 51.4', '', AppColors.ACCENTS[3].value, 010100, 1100,
                1230, 0, '', '', 3, 4.0, true),
            Course(0, 'NSTP 11', '', AppColors.ACCENTS[4].value, 000001, 1400,
                1700, 0, '', '', 3, 4.0, false),
            Course(0, 'PHYED 145', '', AppColors.ACCENTS[0].value, 101000, 1600,
                1700, 0, '', '', 2, 4.0, false),
            Course(0, 'PHYS 160', '', AppColors.ACCENTS[1].value, 010110, 0800,
                0900, 0, '', '', 5, 4.0, true),
            Course(0, 'THEO 12', '', AppColors.ACCENTS[2].value, 010100, 1230,
                1400, 0, '', '', 3, 4.0, true),
          ],
        ),
      ],
